...
import dev.jackwith.skyCoreV2.databases.UpgradeDB;
...
public class UpgradesCommand extends BaseCommand {
    ...
    private final UpgradeDB upgradeDB = plugin.getUpgradeDB();
    ...
    public void setLevel(CommandSender sender, OfflinePlayer target, int level) {
        ...
        upgradeDB.loadUserData(target.getUniqueId());
        upgradeDB.setLevel(target.getUniqueId(), level);
        upgradeDB.clearExpired(target.getUniqueId());
        upgradeDB.flushDirtyPlayers();
